...
class MjsActuator:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    def set_to_adhesion(self, gain: float) -> None: ...
    def set_to_cylinder(self, timeconst: float, bias: float, area: float, diameter: float = ...) -> None: ...
    def set_to_damper(self, kv: float) -> None: ...
    def set_to_intvelocity(self, kp: float, kv: float = ..., dampratio: float = ..., timeconst: float = ..., inheritrange: bool = ...) -> None: ...
    def set_to_motor(self) -> None: ...
    def set_to_muscle(self, timeconst: float = ..., tausmooth: float, range: float = ..., force: float = ..., scale: float = ..., lmin: float = ..., lmax: float = ..., vmax: float = ..., fpmax: float = ..., fvmax: float = ...) -> None: ...
    def set_to_position(self, kp: float, kv: float = ..., dampratio: float = ..., timeconst: float = ..., inheritrange: bool = ...) -> None: ...
    def set_to_velocity(self, kv: float) -> None: ...
    @property
    def id(self) -> int: ...
    @property
